...
| 7 | [Intelligent Document Processing](./doc-processing/) — Textract/Comprehend/Bedrock pipeline on Step Functions with extraction-geometry overlays, a PII redaction exhibit, per-document cost receipts, and a faceted search index | always-on | ✅ **[live](https://documents.demos.planetek.org)** (5 anonymous uploads/day; higher tier on request) |
