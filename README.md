...
| 4 | [Containers](./container-works/) — launch a real Fargate task on demand and watch it live (lifecycle, streaming logs, exit codes, S3 report artifact); CodeBuild→ECR image pipeline with scan-on-push | always-on (scale-to-zero compute) | ✅ **[live](https://containers.demos.planetek.org)** |
