...
| 12 | [Model Workbench](./model-workbench/) — one prompt → four foundation models from four vendors via the Bedrock Converse API, side by side with measured latency/tokens/cost and an audit ledger; public-sector scenario library with a grounding refusal test | always-on | ✅ **[live](https://models.demos.planetek.org)** (5 free runs/day, sign-in for more) |
