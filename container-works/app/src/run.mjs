...
<style>
  body{font:15px/1.5 ui-sans-serif,system-ui,sans-serif;color:#1c1917;background:#fafaf9;margin:0;padding:32px 16px}
  .sheet{max-width:720px;margin:0 auto;background:#fff;border:1px solid #e7e5e4;border-radius:14px;padding:32px}
  h1{font-size:22px;margin:0}  .sub{color:#78716c;font-size:13px;margin-top:4px}
  h2{font-size:14px;text-transform:uppercase;letter-spacing:.06em;color:#78716c;margin:28px 0 10px}
  table{width:100%;border-collapse:collapse;font-size:14px}
  th,td{text-align:left;padding:7px 10px;border-bottom:1px solid #e7e5e4}
  th{font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#78716c}
  .chart{display:flex;align-items:flex-end;gap:3px;height:70px;margin-top:6px}
  .bar{flex:1;background:#2f615c;border-radius:2px 2px 0 0;min-height:2px}
  .meta{margin-top:28px;padding-top:14px;border-top:1px dashed #e7e5e4;font-size:12px;color:#78716c}
  .meta code{background:#f5f5f4;padding:1px 5px;border-radius:5px}
  .stamp{display:inline-block;margin-top:14px;padding:3px 10px;border:1.5px solid #2f615c;border-radius:999px;color:#2f615c;font-weight:700;font-size:12px}
