...
resource "aws_cloudfront_response_headers_policy" "security" {
  ...
  # Belt-and-suspenders with robots.txt: keep the workbench out of search
  # indexes so strangers don't find the token-spending surface by Googling.
...
resource "aws_cloudfront_distribution" "site" {
  ...
  comment             = "Alpenglow Model Workbench (aws-boardwalk / model-workbench)"
