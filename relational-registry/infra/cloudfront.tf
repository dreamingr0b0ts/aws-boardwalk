...
resource "aws_cloudfront_response_headers_policy" "security" {
  ...
  security_headers_config {
    ...
    content_security_policy {
      # Everything is same-origin: /api/* rides this distribution and the
      # standalone evidence.html artifact carries inline styles.
...
resource "aws_cloudfront_distribution" "site" {
  ...
  comment             = "Alpenglow Land & Records Registry (aws-boardwalk / relational-registry)"
