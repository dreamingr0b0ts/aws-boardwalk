  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-pine-950 text-white">
        ...
        />
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-pine-950/95 via-pine-950/95 to-pine-950/60" aria-hidden />
      ...
      <section className="relative isolate overflow-hidden bg-pine-950 text-white">
        ...
        />
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-pine-950/95 via-pine-950/90 to-pine-950/55" aria-hidden />
